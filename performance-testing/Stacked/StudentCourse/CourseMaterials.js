...
// courseMaterials
export default function courseMaterials(data) {
  ...
  group('Course Materials', () => {
    group('Course Materials Page', () => {
      const courseMaterials = http.get(
        `${env.stacked.url}/courses/3KpYzeEJybGQ/grades`
      );

      check(courseMaterials, {
