...
// CourseGrades
export default function courseGrades(data) {
  ...
  group('Course Grades', () => {
    group('Course Grades Page', () => {
      const courseGrades = http.get(
        `${env.stacked.url}/courses/XpV9DNNDYrwz/grades`
      );
