...
// CourseLessons
export default function courseLessons(data) {
  ...
  group('Course Lessons', () => {
    group('Course Lessons Page', () => {
      const courseLessons = http.get(
        `${env.stacked.url}/courses/3KpYzeEJybGQ/modules`
      );
